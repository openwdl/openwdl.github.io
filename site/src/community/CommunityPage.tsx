 ...
 *
 * Kept in the repository but deliberately unrouted: the site's manifest no
 * longer lists a community route, so this page is neither built nor served and
 * `/community/` returns the not-found document. The component and its tests
 * stay here so the content survives and keeps compiling while its future is
 * decided. Restoring it means adding the route back to the manifest, the route
 * union, the `SiteApp` switch, and the prerender metadata.
 */

...
headingAliases:
  ...
  read-int: read_int
  read-float: read_float
  read-boolean: read_boolean
  read-lines: read_lines
  write-lines: write_lines
  read-tsv: read_tsv
  write-tsv: write_tsv
  read-map: read_map
  write-map: write_map
...
optional second argument is specified with a unit
...
The return value is of type `Union` and must be used in a context

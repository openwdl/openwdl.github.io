---
title: "Workflows"
description: "Computation graphs that connect global inputs, outputs, and tasks together."
...
kind: guide
legacy:
  - /docs/write/workflows/
  - /language-guide/workflows
  - /language-guide/workflows.html
  - /language-guide/workflows/
---
...
you read the relevant sections in the [Tasks](/docs/start/language/tasks/) section.
...
(see [this design pattern](/docs/start/patterns/task-aliasing/) for more information).
...
([link](/docs/start/patterns/linear-chaining/)). We highly recommend you read that section

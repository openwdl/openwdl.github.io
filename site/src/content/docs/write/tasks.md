...
broader [workflow](/docs/start/language/workflows/).
...
the [Variables](/docs/start/language/variables/#declarations) section of the language guide.
...
covered in the [Variables](/docs/start/language/variables/#declarations) section of the language guide.
...
task run {
  ...
  parameter_meta {
    source_file: {
      help: "The `source_file` parameter defines an input file that is used to ..."
    },
    out: {

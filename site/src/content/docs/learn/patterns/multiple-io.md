---
title: "Multiple I/O"
description: "Wire tasks with multiple inputs and outputs across a workflow."
slug: /docs/start/patterns/multiple-io/
section: learn
...
multiple inputs and multiple outputs concept.](/docs/patterns/multiple-io/header.png)

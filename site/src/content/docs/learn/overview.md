---
title: "Overview"
description: "WDL is an open standard for describing data processing workflows using a human-readable and writable syntax."
...
- **Portability.** WDL aims to be portable—if your task or workflow conforms to the WDL
  ...
  integrations](/docs/start/ecosystem/#ide-support) in your editor and follow
...
* Follow the quickstart guide to learn the most important concepts in WDL
  ([link](/docs/start/your-first-workflow/)).
...
* Select an execution engine for the environment(s) you're planning to run your
  ...
  ([link](/docs/start/ecosystem/#execution-engines))—contributing issues and ideas to these
...
[contributing]: /docs/start/contributing/

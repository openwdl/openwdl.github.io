...
authors: [clay-mcleod]
genre: release
standfirst: "WDL 1.3 improves language ergonomics, type safety, retry behavior, and cross-engine consistency."
featured: true
version: 1.3.0
...
In anticipation of package management features coming in a future version of WDL, v1.3 relaxes this requirement in [#698](https://github.com/openwdl/wdl/pull/698).

> **Compatibility note**
>
> Documents can now import any document with the same major version and a minor version less than or equal to their own. A v1.3 workflow can import v1.2 tasks; a v1.2 workflow cannot import v1.3 tasks.
...
If you want to try these features today, Sprocket already supports WDL v1.3 in full—you can learn how to install it at [sprocket.bio](https://sprocket.bio/installation.html). To check which execution engines support v1.3, see the compliance status at the top of the [README](https://github.com/openwdl/wdl/blob/wdl-1.3/README.md). If you have ideas for future versions, run into issues, or just want to follow along with development, join the [OpenWDL Slack](https://openwdl.slack.com) or open an issue on the [specification repository](https://github.com/openwdl/wdl).

...
function buildPageMeta(
  ...
  if (route.kind === "brand") {
    return {
      title: "OpenWDL Brand Guidelines",
      description: "Logos, colors, type, and usage guidance for the OpenWDL visual identity.",
      canonical,
      noindex: false,
    };
  }
  ...
  if (route.kind === "community") {
    return {
      title: "Community | OpenWDL",
      description:
        "Find ways to learn, get help, share workflows, contribute tools, test engines, and shape the WDL specification.",
      canonical,
      noindex: false,
    };
  }
  ...
  if (route.kind === "get-started") {
    return {
      title: "Get Started | OpenWDL",
      description: "Follow the guided setup wizard to install WDL tools and run your first workflow.",
      canonical,
      noindex: false,
    };
  }
